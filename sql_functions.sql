...
-- NVL, NVLIF, COLLASCE, NULLIF
-- NVL: REPLACES NULL VALUES WITH THE VALUE OF SAME DATATYPE,  GIVEN BY FUNCTION
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, NVL(COMMISSION_PCT, 0) FROM HR.EMPLOYEES;
--NVL2(COL, VAL1, VAL2): COL != NULL? VAL1:VAL2
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, NVL2(COMMISSION_PCT,COMMISSION_PCT,  0) FROM HR.EMPLOYEES;
--NULLIF(EXP1, EXP2): EXP1==EXP2 ? NULL:EXP1
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, NULLIF(COMMISSION_PCT,COMMISSION_PCT) FROM HR.EMPLOYEES;
--COLLAESCE: RETURNS FIRST NOT NULL VALUE
SELECT EMPLOYEE_ID, COALESCE(COMMISSION_PCT, MANAGER_ID) FROM HR.EMPLOYEES;                                                        
