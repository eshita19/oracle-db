...
-- PAIRWISE COMPARISON QUERY:DISPLAY DETAILS OF EMPLOYEES WHO ARE MANAGED BY SAME MANAGER AND WORK IN SAME DEPARTMENT AS THE EMPLOYEES WITH FIRST NAME "JOHN"
SELECT * FROM HR.EMPLOYEES
WHERE (MANAGER_ID,DEPARTMENT_ID) IN  (SELECT MANAGER_ID, DEPARTMENT_ID FROM HR.EMPLOYEES WHERE FIRST_NAME='John')

-- NON-PAIRWISE COMPARISON QUERY: 
SELECT * FROM HR.EMPLOYEES
...
--SCALAR SUBQUERY: SELECTS ONE ROW, WITH ONLY ONE COLUMN
-- CORELATED SUBQUERY : IT IS SCALAR SUBQUERY
